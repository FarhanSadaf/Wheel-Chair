...
### *How to run*
1. Assemble hardware components according to [Connection diagram](#_Connection_diagram).
...
<img src="https://github.com/FarhanSadaf/Wheel-Chair/blob/main/tutorial/bluetooth-app-to-car-1.svg" width=70%>
